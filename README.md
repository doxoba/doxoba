...
<img src="assets/banner.svg" width="100%" alt="MARY! 메리 · 운영 × AX 기획자 — 지금 파이썬 배우는 중">

<img src="assets/typing.svg" width="100%" alt="운영 현장을 데이터와 AI로 바꾸는 메리 / 전국 배달 운영 · SLA 관리 · 고객사 계약관리 / 지금은 파이썬 배우는 중!">

<img src="assets/chips.svg" width="100%" alt="Ops & Planning · AX · Excel · SQL · Power Query · Python 공부 중"><br><br><br>
...
## <img src="assets/h-career.svg" height="52" alt="CAREER · 경력">
<img src="assets/c-company.svg" width="520" alt="바로고 (Barogo) — 전국 단위 라스트마일 배달 플랫폼">

**재직 기간** `[입사 연월]` ~ 2026.08 <!-- TODO: 입사 연월 -->

<br>

<img src="assets/c-b2b.svg" width="520" alt="B2B사업팀 — 전국 배달 운영 · SLA 관리 · 고객사 계약관리 · 기준 관리">
...
<img src="assets/c-ax.svg" width="520" alt="AX 협의체 — 사내 AI Transformation, 자동화 과제 발굴과 실행 (B2B사업팀 겸직)">
...
<img src="assets/c-cx.svg" width="520" alt="CX운영팀 — CX 운영 · 브랜드 계정 관리">
...
## <img src="assets/h-works.svg" height="52" alt="WORKS · 작업 이력">
...
## <img src="assets/h-roadmap.svg" height="52" alt="ROADMAP · 부트캠프">

> *HYUNDAI AI 서비스 기획 부트캠프 수강중 `[~27' 04]` 

```mermaid
%%{init: {'theme':'base','themeVariables':{'fontFamily':'Apple SD Gothic Neo, Malgun Gothic, sans-serif','fontSize':'14px','lineColor':'#111111','primaryTextColor':'#111111'}}}%%
flowchart LR
  A["✅ 파이썬 1"]:::done --> B["🔄 파이썬 2<br/>함수 · 클래스"]:::doing --> C["⬜ 크롤링"]:::todo --> D["⬜ ChatGPT<br/>API"]:::todo --> E["⬜ 프로젝트"]:::todo
  classDef done fill:#b6ff2e,stroke:#111111,stroke-width:3px,color:#111111
  classDef doing fill:#ff3d9a,stroke:#111111,stroke-width:3px,color:#ffffff
  classDef todo fill:#ffffff,stroke:#111111,stroke-width:2px,color:#555555,stroke-dasharray:4 3
...
## <img src="assets/h-personality.svg" height="52" alt="PERSONALITY · 성격">
...
## <img src="assets/h-contact.svg" height="52" alt="CONTACT">
